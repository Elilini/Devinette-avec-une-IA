...
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
    ...
    \vspace{1cm}
      {\Large Licence CMI première année}\\
    \vspace{1cm}
      {\huge 
	...
	\begin{tabular}{>{\bfseries}lll}
        ...
        \end{tabular}
 \begin{tabular}{c c c}
        \includegraphics[width=3cm]{Image-projet2.jpg} & \includegraphics[width=3cm]{Screenshot_20250330_122024_Gallery.jpg} & \includegraphics[width=3cm]{none.png} \\
        YAHYA LABCHIRI Rania  & IDHAYAKUMAR Elilini  & Ait abdelouhab Yuna 42009159   \\
        4400833 & 44011065 & élève passée en régime dérogatoire \\
    \end{tabular}

    \vspace{1cm}

    \textbf{Lien du dépôt GitHub :} \\[0.5cm]
    \href{https://github.com/Elilini/Devinette-avec-une-IA.git}{https://github.com/projet} \\[3cm]
